...
<script type="text/javascript">
    var graph = new (function() {
        ...
        function drawChart(response) {
            ...
            var options = {
                title: 'Динамика',
                hAxis: {title: 'Время',  titleTextStyle: {color: '#333'}, showTextEvery: Math.round(gdata.length / 5), textStyle: axisStyle},
                vAxis: {minValue: response.minmax[0], maxValue: response.minmax[1], textStyle: axisStyle},
                height: $('#chart_div').height(),
                legend: {position: 'top', maxLines: 6},
                chartArea: {
                    left:30,top:0, width:'100%', height: '90%'
                }
            };
        ...
        this.loadPair = function(pair, addhour, a_decTime, a_all_amount) {
            ...
            var url = 'index.php?module=trade_graph_json';
            ...
            $.getJSON(url, {token: token}, function(a_data) {
...
<div>
    <div class="result chart_area" id="chart_div"></div>
