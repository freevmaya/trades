<?
    ...
    if (isset($_GET['login'])) {
        if (($admin_access['login'] == $_POST['name']) && ($admin_access['password'] == md5($_POST['password']))) 
            $_SESSION['user'] = $admin_access;
...
<div class="trade_body">
    <div class="header">
        <?//include_once('modules/pairs.php');?>
    ...
    <div> 
        ...
        <?include_once('modules/graph2.php');?>
        <?//include_once('modules/transactions.php');?>
